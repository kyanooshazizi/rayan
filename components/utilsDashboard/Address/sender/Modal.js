            ...
            <>
              <ModalBody>
                <div className="bg-[#fff] w-full mt-10">
                    <span className="border-b-2 border-colorgreen border-solid ">ثبت اطلاعات آدرس</span>
                  <form className="mt-6">
                    {/* start table */}
                    {/* start:top */}
                   <div className="flex flex-wrap w-full justify-around sm:flex-row flex-col">
                    ...
                    <input type="text" className="outline-none bg-dashboard border-2 border-solid border-gray-200 w-full px-2 py-2"/>
                    </div>
                    <div className="lg:basis-[28%] sm:basis-[48%] basis-full mt-[5px]">
