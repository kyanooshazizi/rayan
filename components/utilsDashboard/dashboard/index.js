...
import Navmobile from "@/components/utilsDashboard/navbarmobile"
const index = () => {
    ...
    <>
       ...
       <Navmobile/>
        ...
        <div className="lg:relative lg:top-0 lg:left-0 bg-[#f3f6fb]">
          <div className="lg:flex lg:min-h-[680px] lg:h-full hidden fixed bg-[#f3f6fb] w-[140px] mt-[72px]">
            <Sidbar />
          </div>
          <div className="lg:pr-[160px] w-100 min-h-screen flex justify-center">
            <div className="w-full pl-0 mx-auto pr-[15px] mt-[72px]">
              <div>
                {/* start row:1 */}
