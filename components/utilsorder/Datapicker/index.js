     ...
     <div
              ...
              >
                ...
                <div className="w-full text-right mr-3">
                  ...
                  // console.log("eeee",currentMonth,date)
                  //   let tatil=25
                  //   if(currentMonth.index==9&&tatil==date.day||26==date.day) return {
                  //     disabled: true,
                  //     style: { color: "red", backgroundColor:""},
                  //     onClick: () => toast.info('روز های جمعه و روز های تعطیل نمی توانید سفارشی را ثبت کنید', {
                  //       position: "top-center",
                  //       autoClose: 4000,
