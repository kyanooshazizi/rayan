...
const Headerpage = () => {
  return (
    <>
      <header
        className={`w-full min-h-[500px] text-[14px]  md:text-[16px] flex items-center justify-center bg-[url('/imag_homepage/Header.svg')] bg-no-repeat bg-cover`}
      >
        <Navbar />
        <div className="text-txcolor">
          <div className="mt-[130px] sm:w-full w-4/5 mx-auto pb-3">
